...
export function ArticleMeta({
    ...
    const handleShare = (platform: string) => {
        ...
        switch (platform) {
            case "facebook":
                ...
                break
            case "zalo":
                window.open(`https://page.zalo.me/share?url=${encodeURIComponent(url)}`, "_blank")
                break
            case "copy":
    ...
    const handleSaveArticle = () => {
        ...
        if (isSaved) {
            ...
            localStorage.setItem("bookmarks", JSON.stringify(bookmarkList.slice(0, 50)))
            setIsSaved(true)
        }
    }
    ...
    return (
        <div className="mt-4 border-y border-border py-4">
            ...
            <div className="mt-3 flex flex-wrap items-center gap-3">
                <Button variant={isSaved ? "default" : "outline"} size="sm" onClick={handleSaveArticle}
                        className="gap-2">
                ...
                <Button variant="outline" size="sm" onClick={() => handleShare("zalo")} className="gap-2">
