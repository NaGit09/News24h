  ...
  return (
    <div className="bg-primary text-primary-foreground overflow-hidden relative">
      <div className="flex items-center h-9">
        <div className="w-24 flex-shrink-0 px-3 text-xs font-bold whitespace-nowrap flex items-center justify-center gap-1.5 bg-primary border-r border-primary-foreground/20">
