...
export function NewsPreview({ article, className = "" }: NewsPreviewProps) {
  ...
  return (
    <div className={`group relative ${className}`}>
      ...
      <div className="pointer-events-none absolute left-0 top-full z-50 mt-2 hidden w-full max-w-md rounded border border-border bg-background p-4 shadow-2xl group-hover:block">
