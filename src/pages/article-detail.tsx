...
export default function ArticlePage() {
  ...
  const breadcrumbs = [
    ...
    { label: rssArticle.category || "Tin tức", href: `/${rssArticle.category?.toLowerCase().replace(/\s+/g, '-')}` },
  ]
  ...
  // Use full article content if available, otherwise fallback to RSS description
